clear
addpath(genpath('/mnt/storage/Akanksha/SingleCell/June_2021_analysis/sim_data_June2021/vary_cells_m/GT_100x500_10/DT/')); 
%tic
Files=dir('/mnt/storage/Akanksha/SingleCell/June_2021_analysis/sim_data_June2021/vary_cells_m/GT_100x500_10/DT/');
nhd=[];
impute_acc=[];
FPFN_ratio=[];
for kk=3:length(Files)
   ...
   save(['/mnt/storage/Akanksha/SingleCell/June_2021_analysis/sim_data_June2021/vary_cells_m/GT_100x500_10/DT_denoised_RGL_Smatrices/' simi_mat],'S')
   save(['/mnt/storage/Akanksha/SingleCell/June_2021_analysis/sim_data_June2021/vary_cells_m/GT_100x500_10/DT_denoised_RGL/' filedenoise],'AA1')
   ...
   mat_GD = csvread(fullfile('/mnt/storage/Akanksha/SingleCell/June_2021_analysis/sim_data_June2021/vary_cells_m/GT_100x500_10/GT/',strfinal),0,0);
